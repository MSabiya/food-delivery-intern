...
const Login = () => {
  ...
  return (
    ...
    <div className="flex h-[700px] w-full">
            <div className="w-full hidden md:inline-block mx-40 mt-10">
            ...
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <form className="md:w-96 w-80 flex flex-col items-center justify-center mr-80">
                    ...
                    <button type="submit" className="mt-8 w-full h-11 rounded-full text-white bg-indigo-500 hover:opacity-90 transition-opacity active:scale-95 transition">
                        Login
                    </button>
